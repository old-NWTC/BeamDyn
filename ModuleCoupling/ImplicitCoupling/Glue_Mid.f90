...
!...................................................................................................................................
   ...
   TYPE(BD_InputType)                          :: BD1InputRea_temp
   ...
   BD1InputRea_tmp%PointLoad%Force(3,BD1_Parameter%node_total) = &
             BD1_Input%PointLoad%Force(3,BD1_Parameter%node_total) - 1.0D+00
...
!           BD1_Input%PointLoad%Force(j,BD1_Parameter%node_total) = BD1_Input%PointLoad%Force(j,BD1_Parameter%node_total) + eps
           BD1InputRea_tmp%PointLoad%Force(j,BD1_Parameter%node_total) = BD1InputRea_tmp%PointLoad%Force(j,BD1_Parameter%node_total) + eps
           BD1_Input%PointLoad%Force(:,BD1_Parameter%node_total) = BD1InputRea_tmp%PointLoad%Force(:,BD1_Parameter%node_total) +&
                    BD1_Input%PointLoad%Force(:,BD1_Parameter%node_total)
           CALL BD_CalcOutput( time, BD1_Input, BD1_Parameter, BD1_ContinuousState, BD1_DiscreteState, &
           ...
           CALL BD_CopyInput(BD1InputRea_temp,BD1InputRea_tmp,MESH_NEWCOPY,ErrStat,ErrMsg)
       ENDDO
       DO j=1,3
!           BD1_Input%PointLoad%Moment(j,BD1_Parameter%node_total) = BD1_Input%PointLoad%Moment(j,BD1_Parameter%node_total) + eps
           BD1InputRea_tmp%PointLoad%Moment(j,BD1_Parameter%node_total) = BD1InputRea_tmp%PointLoad%Moment(j,BD1_Parameter%node_total) + eps
           BD1_Input%PointLoad%Moment(:,BD1_Parameter%node_total) = BD1InputRea_tmp%PointLoad%Moment(:,BD1_Parameter%node_total) +&
                    BD1_Input%PointLoad%Moment(:,BD1_Parameter%node_total)
           CALL BD_CalcOutput( time, BD1_Input, BD1_Parameter, BD1_ContinuousState, BD1_DiscreteState, &
                    BD1_ConstraintState, BD1_OtherState, BD1OT_tmp, ErrStat, ErrMsg )    
           DO k=1,3
...
!       ENDIF
       ...
       BD1InputRea_tmp%PointLoad%Force(1:3,BD1_Parameter%node_total) = &
            BD1InputRea_tmp%PointLoad%Force(1:3,BD1_Parameter%node_total) + uinc(1:3)
       BD1InputRea_tmp%PointLoad%Moment(1:3,BD1_Parameter%node_total) = &
            BD1InputRea_tmp%PointLoad%Moment(1:3,BD1_Parameter%node_total) + uinc(4:6)
