############
 ...
 set autoscale y;
 plot "Qi_Force.out" using 1:2 with lines ls 1
 set nomultiplot;
 set output;
 ...
 set autoscale y;
 plot "Qi_Force.out" using 1:3 with lines ls 1
 set nomultiplot;
 set output;
 ...
 set autoscale y;
 plot "Qi_Force.out" using 1:4 with lines ls 1
 set nomultiplot;
 set output;
 ...
 set autoscale y;
 plot "Qi_Force.out" using 1:5 with lines ls 1
 set nomultiplot;
 set output;
 ...
 set autoscale y;
 plot "Qi_Force.out" using 1:6 with lines ls 1
 set nomultiplot;
 set output;
 ...
 set autoscale y;
 plot "Qi_Force.out" using 1:7 with lines ls 1
 set nomultiplot;
 set output;