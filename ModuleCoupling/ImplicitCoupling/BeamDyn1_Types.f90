!STARTOFREGISTRYGENERATEDFILE './BeamDyn1_Types.f90'
!
...
!
!*********************************************************************************************************************************
MODULE BeamDyn1_Types
! This module contains all of the user-defined types needed in BeamDyn1. It also contains copy, destroy, pack, and
! unpack routines associated with each defined data type. This code will be generated by the FAST Registry.
!---------------------------------------------------------------------------------------------------------------------------------
USE NWTC_Library
IMPLICIT NONE
! =========  BD1_InitInputType  =======
  TYPE, PUBLIC :: BD1_InitInputType
  ...
  END TYPE BD1_InitInputType
! =======================
! =========  BD1_InitOutputType  =======
  TYPE, PUBLIC :: BD1_InitOutputType
    REAL(ReKi)  :: DummyInitVar      ! A variable [-]
  END TYPE BD1_InitOutputType
! =======================
! =========  BD1_ContinuousStateType  =======
  TYPE, PUBLIC :: BD1_ContinuousStateType
  ...
  END TYPE BD1_ContinuousStateType
! =======================
! =========  BD1_DiscreteStateType  =======
  TYPE, PUBLIC :: BD1_DiscreteStateType
    REAL(ReKi)  :: DummyDiscState      ! A variable, Replace if you have discrete states [-]
  END TYPE BD1_DiscreteStateType
! =======================
! =========  BD1_ConstraintStateType  =======
  TYPE, PUBLIC :: BD1_ConstraintStateType
    REAL(ReKi)  :: DummyConstrState      ! A variable, Replace if you have constraint states [-]
  END TYPE BD1_ConstraintStateType
! =======================
! =========  BD1_OtherStateType  =======
  TYPE, PUBLIC :: BD1_OtherStateType
  ...
  END TYPE BD1_OtherStateType
! =======================
! =========  BD1_ParameterType  =======
  TYPE, PUBLIC :: BD1_ParameterType
  ...
  END TYPE BD1_ParameterType
! =======================
! =========  BD1_InputType  =======
  TYPE, PUBLIC :: BD1_InputType
  ...
  END TYPE BD1_InputType
! =======================
! =========  BD1_OutputType  =======
  TYPE, PUBLIC :: BD1_OutputType
...
! =========  BD1_InputFile  =======
  TYPE, PUBLIC :: BD1_InputFile
    ...
    LOGICAL  :: Echo      ! Echo [-]
  END TYPE BD1_InputFile
! =======================
CONTAINS
 SUBROUTINE BD1_CopyInitInput( SrcInitInputData, DstInitInputData, CtrlCode, ErrStat, ErrMsg )
   TYPE(BD1_initinputtype), INTENT(INOUT) :: SrcInitInputData
   TYPE(BD1_initinputtype), INTENT(INOUT) :: DstInitInputData
...
IF (ALLOCATED(SrcInitInputData%gravity)) THEN
   ...
   IF (.NOT. ALLOCATED(DstInitInputData%gravity)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyInitInput: Error allocating DstInitInputData%gravity.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcInitInputData%GlbPos)) THEN
   ...
   IF (.NOT. ALLOCATED(DstInitInputData%GlbPos)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyInitInput: Error allocating DstInitInputData%GlbPos.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcInitInputData%GlbRot)) THEN
   ...
   IF (.NOT. ALLOCATED(DstInitInputData%GlbRot)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyInitInput: Error allocating DstInitInputData%GlbRot.'
         RETURN
      END IF
   END IF
   DstInitInputData%GlbRot = SrcInitInputData%GlbRot
ENDIF
 END SUBROUTINE BD1_CopyInitInput

 SUBROUTINE BD1_DestroyInitInput( InitInputData, ErrStat, ErrMsg )
  TYPE(BD1_initinputtype), INTENT(INOUT) :: InitInputData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
...
ENDIF
 END SUBROUTINE BD1_DestroyInitInput

 SUBROUTINE BD1_PackInitInput( ReKiBuf, DbKiBuf, IntKiBuf, Indata, ErrStat, ErrMsg, SizeOnly )
  REAL(ReKi),       ALLOCATABLE, INTENT(  OUT) :: ReKiBuf(:)
  REAL(DbKi),       ALLOCATABLE, INTENT(  OUT) :: DbKiBuf(:)
  INTEGER(IntKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
  TYPE(BD1_initinputtype),  INTENT(INOUT) :: InData
  INTEGER(IntKi),   INTENT(  OUT) :: ErrStat
  CHARACTER(*),     INTENT(  OUT) :: ErrMsg
 ...
 ! buffers to store meshes, if any
  ...
  ENDIF
 END SUBROUTINE BD1_PackInitInput

 SUBROUTINE BD1_UnPackInitInput( ReKiBuf, DbKiBuf, IntKiBuf, Outdata, ErrStat, ErrMsg )
  REAL(ReKi),      ALLOCATABLE, INTENT(IN   ) :: ReKiBuf(:)
  REAL(DbKi),      ALLOCATABLE, INTENT(IN   ) :: DbKiBuf(:)
  INTEGER(IntKi),  ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
  TYPE(BD1_initinputtype), INTENT(INOUT) :: OutData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
    ! Local variables
  INTEGER(IntKi)                 :: Re_BufSz
 ...
 END SUBROUTINE BD1_UnPackInitInput

 SUBROUTINE BD1_CopyInitOutput( SrcInitOutputData, DstInitOutputData, CtrlCode, ErrStat, ErrMsg )
   TYPE(BD1_initoutputtype), INTENT(INOUT) :: SrcInitOutputData
   TYPE(BD1_initoutputtype), INTENT(INOUT) :: DstInitOutputData
   INTEGER(IntKi),  INTENT(IN   ) :: CtrlCode
   INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
   CHARACTER(*),    INTENT(  OUT) :: ErrMsg
! Local 
...
! 
 ...
 END SUBROUTINE BD1_CopyInitOutput

 SUBROUTINE BD1_DestroyInitOutput( InitOutputData, ErrStat, ErrMsg )
  TYPE(BD1_initoutputtype), INTENT(INOUT) :: InitOutputData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
  INTEGER(IntKi)                 :: i, i1, i2, i3, i4, i5 
! 
  ErrStat = ErrID_None
  ErrMsg  = ""
 END SUBROUTINE BD1_DestroyInitOutput

 SUBROUTINE BD1_PackInitOutput( ReKiBuf, DbKiBuf, IntKiBuf, Indata, ErrStat, ErrMsg, SizeOnly )
  REAL(ReKi),       ALLOCATABLE, INTENT(  OUT) :: ReKiBuf(:)
  REAL(DbKi),       ALLOCATABLE, INTENT(  OUT) :: DbKiBuf(:)
  INTEGER(IntKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
  TYPE(BD1_initoutputtype),  INTENT(INOUT) :: InData
  INTEGER(IntKi),   INTENT(  OUT) :: ErrStat
  CHARACTER(*),     INTENT(  OUT) :: ErrMsg
  LOGICAL,OPTIONAL, INTENT(IN   ) :: SizeOnly
    ! Local variables
 ...
 ! buffers to store meshes, if any
  ...
  Re_Xferred   = Re_Xferred   + 1
 END SUBROUTINE BD1_PackInitOutput

 SUBROUTINE BD1_UnPackInitOutput( ReKiBuf, DbKiBuf, IntKiBuf, Outdata, ErrStat, ErrMsg )
  REAL(ReKi),      ALLOCATABLE, INTENT(IN   ) :: ReKiBuf(:)
  REAL(DbKi),      ALLOCATABLE, INTENT(IN   ) :: DbKiBuf(:)
  INTEGER(IntKi),  ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
  TYPE(BD1_initoutputtype), INTENT(INOUT) :: OutData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
    ! Local variables
  INTEGER(IntKi)                 :: Re_BufSz
 ...
 ! buffers to store meshes, if any
  ...
  Db_Xferred   = Db_Xferred-1
  Int_Xferred  = Int_Xferred-1
 END SUBROUTINE BD1_UnPackInitOutput

 SUBROUTINE BD1_CopyContState( SrcContStateData, DstContStateData, CtrlCode, ErrStat, ErrMsg )
   TYPE(BD1_continuousstatetype), INTENT(INOUT) :: SrcContStateData
   TYPE(BD1_continuousstatetype), INTENT(INOUT) :: DstContStateData
   INTEGER(IntKi),  INTENT(IN   ) :: CtrlCode
   INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
   CHARACTER(*),    INTENT(  OUT) :: ErrMsg
! Local 
...
IF (ALLOCATED(SrcContStateData%q)) THEN
   ...
   IF (.NOT. ALLOCATED(DstContStateData%q)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyContState: Error allocating DstContStateData%q.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcContStateData%dqdt)) THEN
   ...
   IF (.NOT. ALLOCATED(DstContStateData%dqdt)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyContState: Error allocating DstContStateData%dqdt.'
         RETURN
      END IF
   END IF
   DstContStateData%dqdt = SrcContStateData%dqdt
ENDIF
 END SUBROUTINE BD1_CopyContState

 SUBROUTINE BD1_DestroyContState( ContStateData, ErrStat, ErrMsg )
  TYPE(BD1_continuousstatetype), INTENT(INOUT) :: ContStateData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
  INTEGER(IntKi)                 :: i, i1, i2, i3, i4, i5 
! 
...
ENDIF
 END SUBROUTINE BD1_DestroyContState

 SUBROUTINE BD1_PackContState( ReKiBuf, DbKiBuf, IntKiBuf, Indata, ErrStat, ErrMsg, SizeOnly )
  REAL(ReKi),       ALLOCATABLE, INTENT(  OUT) :: ReKiBuf(:)
  REAL(DbKi),       ALLOCATABLE, INTENT(  OUT) :: DbKiBuf(:)
  INTEGER(IntKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
  TYPE(BD1_continuousstatetype),  INTENT(INOUT) :: InData
  INTEGER(IntKi),   INTENT(  OUT) :: ErrStat
  CHARACTER(*),     INTENT(  OUT) :: ErrMsg
  LOGICAL,OPTIONAL, INTENT(IN   ) :: SizeOnly
    ! Local variables
 ...
 ! buffers to store meshes, if any
  ...
  ENDIF
 END SUBROUTINE BD1_PackContState

 SUBROUTINE BD1_UnPackContState( ReKiBuf, DbKiBuf, IntKiBuf, Outdata, ErrStat, ErrMsg )
  REAL(ReKi),      ALLOCATABLE, INTENT(IN   ) :: ReKiBuf(:)
  REAL(DbKi),      ALLOCATABLE, INTENT(IN   ) :: DbKiBuf(:)
  INTEGER(IntKi),  ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
  TYPE(BD1_continuousstatetype), INTENT(INOUT) :: OutData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
    ! Local variables
  INTEGER(IntKi)                 :: Re_BufSz
 ...
 ! buffers to store meshes, if any
  ...
  Db_Xferred   = Db_Xferred-1
  Int_Xferred  = Int_Xferred-1
 END SUBROUTINE BD1_UnPackContState

 SUBROUTINE BD1_CopyDiscState( SrcDiscStateData, DstDiscStateData, CtrlCode, ErrStat, ErrMsg )
   TYPE(BD1_discretestatetype), INTENT(INOUT) :: SrcDiscStateData
   TYPE(BD1_discretestatetype), INTENT(INOUT) :: DstDiscStateData
   INTEGER(IntKi),  INTENT(IN   ) :: CtrlCode
   INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
   CHARACTER(*),    INTENT(  OUT) :: ErrMsg
! Local 
...
! 
 ...
 END SUBROUTINE BD1_CopyDiscState

 SUBROUTINE BD1_DestroyDiscState( DiscStateData, ErrStat, ErrMsg )
  TYPE(BD1_discretestatetype), INTENT(INOUT) :: DiscStateData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
  INTEGER(IntKi)                 :: i, i1, i2, i3, i4, i5 
! 
  ErrStat = ErrID_None
  ErrMsg  = ""
 END SUBROUTINE BD1_DestroyDiscState

 SUBROUTINE BD1_PackDiscState( ReKiBuf, DbKiBuf, IntKiBuf, Indata, ErrStat, ErrMsg, SizeOnly )
  REAL(ReKi),       ALLOCATABLE, INTENT(  OUT) :: ReKiBuf(:)
  REAL(DbKi),       ALLOCATABLE, INTENT(  OUT) :: DbKiBuf(:)
  INTEGER(IntKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
  TYPE(BD1_discretestatetype),  INTENT(INOUT) :: InData
  INTEGER(IntKi),   INTENT(  OUT) :: ErrStat
  CHARACTER(*),     INTENT(  OUT) :: ErrMsg
  LOGICAL,OPTIONAL, INTENT(IN   ) :: SizeOnly
    ! Local variables
 ...
 ! buffers to store meshes, if any
  ...
  Re_Xferred   = Re_Xferred   + 1
 END SUBROUTINE BD1_PackDiscState

 SUBROUTINE BD1_UnPackDiscState( ReKiBuf, DbKiBuf, IntKiBuf, Outdata, ErrStat, ErrMsg )
  REAL(ReKi),      ALLOCATABLE, INTENT(IN   ) :: ReKiBuf(:)
  REAL(DbKi),      ALLOCATABLE, INTENT(IN   ) :: DbKiBuf(:)
  INTEGER(IntKi),  ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
  TYPE(BD1_discretestatetype), INTENT(INOUT) :: OutData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
    ! Local variables
  INTEGER(IntKi)                 :: Re_BufSz
 ...
 ! buffers to store meshes, if any
  ...
  Db_Xferred   = Db_Xferred-1
  Int_Xferred  = Int_Xferred-1
 END SUBROUTINE BD1_UnPackDiscState

 SUBROUTINE BD1_CopyConstrState( SrcConstrStateData, DstConstrStateData, CtrlCode, ErrStat, ErrMsg )
   TYPE(BD1_constraintstatetype), INTENT(INOUT) :: SrcConstrStateData
   TYPE(BD1_constraintstatetype), INTENT(INOUT) :: DstConstrStateData
   INTEGER(IntKi),  INTENT(IN   ) :: CtrlCode
   INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
   CHARACTER(*),    INTENT(  OUT) :: ErrMsg
! Local 
...
! 
 ...
 END SUBROUTINE BD1_CopyConstrState

 SUBROUTINE BD1_DestroyConstrState( ConstrStateData, ErrStat, ErrMsg )
  TYPE(BD1_constraintstatetype), INTENT(INOUT) :: ConstrStateData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
  INTEGER(IntKi)                 :: i, i1, i2, i3, i4, i5 
! 
  ErrStat = ErrID_None
  ErrMsg  = ""
 END SUBROUTINE BD1_DestroyConstrState

 SUBROUTINE BD1_PackConstrState( ReKiBuf, DbKiBuf, IntKiBuf, Indata, ErrStat, ErrMsg, SizeOnly )
  REAL(ReKi),       ALLOCATABLE, INTENT(  OUT) :: ReKiBuf(:)
  REAL(DbKi),       ALLOCATABLE, INTENT(  OUT) :: DbKiBuf(:)
  INTEGER(IntKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
  TYPE(BD1_constraintstatetype),  INTENT(INOUT) :: InData
  INTEGER(IntKi),   INTENT(  OUT) :: ErrStat
  CHARACTER(*),     INTENT(  OUT) :: ErrMsg
  LOGICAL,OPTIONAL, INTENT(IN   ) :: SizeOnly
    ! Local variables
 ...
 ! buffers to store meshes, if any
  ...
  Re_Xferred   = Re_Xferred   + 1
 END SUBROUTINE BD1_PackConstrState

 SUBROUTINE BD1_UnPackConstrState( ReKiBuf, DbKiBuf, IntKiBuf, Outdata, ErrStat, ErrMsg )
  REAL(ReKi),      ALLOCATABLE, INTENT(IN   ) :: ReKiBuf(:)
  REAL(DbKi),      ALLOCATABLE, INTENT(IN   ) :: DbKiBuf(:)
  INTEGER(IntKi),  ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
  TYPE(BD1_constraintstatetype), INTENT(INOUT) :: OutData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
    ! Local variables
  INTEGER(IntKi)                 :: Re_BufSz
 ...
 ! buffers to store meshes, if any
  ...
  Db_Xferred   = Db_Xferred-1
  Int_Xferred  = Int_Xferred-1
 END SUBROUTINE BD1_UnPackConstrState

 SUBROUTINE BD1_CopyOtherState( SrcOtherStateData, DstOtherStateData, CtrlCode, ErrStat, ErrMsg )
   TYPE(BD1_otherstatetype), INTENT(INOUT) :: SrcOtherStateData
   TYPE(BD1_otherstatetype), INTENT(INOUT) :: DstOtherStateData
   INTEGER(IntKi),  INTENT(IN   ) :: CtrlCode
   INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
   CHARACTER(*),    INTENT(  OUT) :: ErrMsg
! Local 
...
IF (ALLOCATED(SrcOtherStateData%acc)) THEN
   ...
   IF (.NOT. ALLOCATED(DstOtherStateData%acc)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyOtherState: Error allocating DstOtherStateData%acc.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcOtherStateData%xcc)) THEN
   ...
   IF (.NOT. ALLOCATED(DstOtherStateData%xcc)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyOtherState: Error allocating DstOtherStateData%xcc.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcOtherStateData%facc)) THEN
   ...
   IF (.NOT. ALLOCATED(DstOtherStateData%facc)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyOtherState: Error allocating DstOtherStateData%facc.'
         RETURN
      END IF
   END IF
   DstOtherStateData%facc = SrcOtherStateData%facc
ENDIF
 END SUBROUTINE BD1_CopyOtherState

 SUBROUTINE BD1_DestroyOtherState( OtherStateData, ErrStat, ErrMsg )
  TYPE(BD1_otherstatetype), INTENT(INOUT) :: OtherStateData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
  INTEGER(IntKi)                 :: i, i1, i2, i3, i4, i5 
! 
...
ENDIF
 END SUBROUTINE BD1_DestroyOtherState

 SUBROUTINE BD1_PackOtherState( ReKiBuf, DbKiBuf, IntKiBuf, Indata, ErrStat, ErrMsg, SizeOnly )
  REAL(ReKi),       ALLOCATABLE, INTENT(  OUT) :: ReKiBuf(:)
  REAL(DbKi),       ALLOCATABLE, INTENT(  OUT) :: DbKiBuf(:)
  INTEGER(IntKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
  TYPE(BD1_otherstatetype),  INTENT(INOUT) :: InData
  INTEGER(IntKi),   INTENT(  OUT) :: ErrStat
  CHARACTER(*),     INTENT(  OUT) :: ErrMsg
  LOGICAL,OPTIONAL, INTENT(IN   ) :: SizeOnly
    ! Local variables
 ...
 ! buffers to store meshes, if any
  ...
  ENDIF
 END SUBROUTINE BD1_PackOtherState

 SUBROUTINE BD1_UnPackOtherState( ReKiBuf, DbKiBuf, IntKiBuf, Outdata, ErrStat, ErrMsg )
  REAL(ReKi),      ALLOCATABLE, INTENT(IN   ) :: ReKiBuf(:)
  REAL(DbKi),      ALLOCATABLE, INTENT(IN   ) :: DbKiBuf(:)
  INTEGER(IntKi),  ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
  TYPE(BD1_otherstatetype), INTENT(INOUT) :: OutData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
    ! Local variables
  INTEGER(IntKi)                 :: Re_BufSz
 ...
 ! buffers to store meshes, if any
  ...
  Db_Xferred   = Db_Xferred-1
  Int_Xferred  = Int_Xferred-1
 END SUBROUTINE BD1_UnPackOtherState

 SUBROUTINE BD1_CopyParam( SrcParamData, DstParamData, CtrlCode, ErrStat, ErrMsg )
   TYPE(BD1_parametertype), INTENT(INOUT) :: SrcParamData
   TYPE(BD1_parametertype), INTENT(INOUT) :: DstParamData
   INTEGER(IntKi),  INTENT(IN   ) :: CtrlCode
   INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
   CHARACTER(*),    INTENT(  OUT) :: ErrMsg
! Local 
...
IF (ALLOCATED(SrcParamData%uuN0)) THEN
   ...
   IF (.NOT. ALLOCATED(DstParamData%uuN0)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyParam: Error allocating DstParamData%uuN0.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcParamData%Stif0_GL)) THEN
   ...
   IF (.NOT. ALLOCATED(DstParamData%Stif0_GL)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyParam: Error allocating DstParamData%Stif0_GL.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcParamData%Mass0_GL)) THEN
   ...
   IF (.NOT. ALLOCATED(DstParamData%Mass0_GL)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyParam: Error allocating DstParamData%Mass0_GL.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcParamData%gravity)) THEN
   ...
   IF (.NOT. ALLOCATED(DstParamData%gravity)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyParam: Error allocating DstParamData%gravity.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcParamData%segment_length)) THEN
   ...
   IF (.NOT. ALLOCATED(DstParamData%segment_length)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyParam: Error allocating DstParamData%segment_length.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcParamData%member_length)) THEN
   ...
   IF (.NOT. ALLOCATED(DstParamData%member_length)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyParam: Error allocating DstParamData%member_length.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcParamData%beta)) THEN
   ...
   IF (.NOT. ALLOCATED(DstParamData%beta)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyParam: Error allocating DstParamData%beta.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcParamData%coef)) THEN
   ...
   IF (.NOT. ALLOCATED(DstParamData%coef)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyParam: Error allocating DstParamData%coef.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcParamData%GlbPos)) THEN
   ...
   IF (.NOT. ALLOCATED(DstParamData%GlbPos)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyParam: Error allocating DstParamData%GlbPos.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcParamData%GlbRot)) THEN
   ...
   IF (.NOT. ALLOCATED(DstParamData%GlbRot)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_CopyParam: Error allocating DstParamData%GlbRot.'
         RETURN
      END IF
   END IF
   DstParamData%GlbRot = SrcParamData%GlbRot
ENDIF
 END SUBROUTINE BD1_CopyParam

 SUBROUTINE BD1_DestroyParam( ParamData, ErrStat, ErrMsg )
  TYPE(BD1_parametertype), INTENT(INOUT) :: ParamData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
  INTEGER(IntKi)                 :: i, i1, i2, i3, i4, i5 
! 
...
ENDIF
 END SUBROUTINE BD1_DestroyParam

 SUBROUTINE BD1_PackParam( ReKiBuf, DbKiBuf, IntKiBuf, Indata, ErrStat, ErrMsg, SizeOnly )
  REAL(ReKi),       ALLOCATABLE, INTENT(  OUT) :: ReKiBuf(:)
  REAL(DbKi),       ALLOCATABLE, INTENT(  OUT) :: DbKiBuf(:)
  INTEGER(IntKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
  TYPE(BD1_parametertype),  INTENT(INOUT) :: InData
  INTEGER(IntKi),   INTENT(  OUT) :: ErrStat
  CHARACTER(*),     INTENT(  OUT) :: ErrMsg
  LOGICAL,OPTIONAL, INTENT(IN   ) :: SizeOnly
    ! Local variables
 ...
 ! buffers to store meshes, if any
  ...
  IF ( ALLOCATED(InData%GlbRot) ) THEN
    ...
    Re_Xferred   = Re_Xferred   + SIZE(InData%GlbRot)
  ENDIF
 END SUBROUTINE BD1_PackParam

 SUBROUTINE BD1_UnPackParam( ReKiBuf, DbKiBuf, IntKiBuf, Outdata, ErrStat, ErrMsg )
  REAL(ReKi),      ALLOCATABLE, INTENT(IN   ) :: ReKiBuf(:)
  REAL(DbKi),      ALLOCATABLE, INTENT(IN   ) :: DbKiBuf(:)
  INTEGER(IntKi),  ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
  TYPE(BD1_parametertype), INTENT(INOUT) :: OutData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
    ! Local variables
  INTEGER(IntKi)                 :: Re_BufSz
 ...
 ! buffers to store meshes, if any
  ...
  Db_Xferred   = Db_Xferred-1
  Int_Xferred  = Int_Xferred-1
 END SUBROUTINE BD1_UnPackParam

 SUBROUTINE BD1_CopyInput( SrcInputData, DstInputData, CtrlCode, ErrStat, ErrMsg )
   TYPE(BD1_inputtype), INTENT(INOUT) :: SrcInputData
   TYPE(BD1_inputtype), INTENT(INOUT) :: DstInputData
   INTEGER(IntKi),  INTENT(IN   ) :: CtrlCode
   INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
   CHARACTER(*),    INTENT(  OUT) :: ErrMsg
! Local 
...
! 
 ...
 END SUBROUTINE BD1_CopyInput

 SUBROUTINE BD1_DestroyInput( InputData, ErrStat, ErrMsg )
  TYPE(BD1_inputtype), INTENT(INOUT) :: InputData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
  INTEGER(IntKi)                 :: i, i1, i2, i3, i4, i5 
! 
 ...
 END SUBROUTINE BD1_DestroyInput

 SUBROUTINE BD1_PackInput( ReKiBuf, DbKiBuf, IntKiBuf, Indata, ErrStat, ErrMsg, SizeOnly )
  REAL(ReKi),       ALLOCATABLE, INTENT(  OUT) :: ReKiBuf(:)
  REAL(DbKi),       ALLOCATABLE, INTENT(  OUT) :: DbKiBuf(:)
  INTEGER(IntKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
  TYPE(BD1_inputtype),  INTENT(INOUT) :: InData
  INTEGER(IntKi),   INTENT(  OUT) :: ErrStat
  CHARACTER(*),     INTENT(  OUT) :: ErrMsg
  LOGICAL,OPTIONAL, INTENT(IN   ) :: SizeOnly
    ! Local variables
 ...
 ! Allocate mesh buffers, if any (we'll also get sizes from these) 
  ...
  IF( ALLOCATED(Db_DistrLoad_Buf) )  DEALLOCATE(Db_DistrLoad_Buf)
  IF( ALLOCATED(Int_DistrLoad_Buf) ) DEALLOCATE(Int_DistrLoad_Buf)
 END SUBROUTINE BD1_PackInput

 SUBROUTINE BD1_UnPackInput( ReKiBuf, DbKiBuf, IntKiBuf, Outdata, ErrStat, ErrMsg )
  REAL(ReKi),      ALLOCATABLE, INTENT(IN   ) :: ReKiBuf(:)
  REAL(DbKi),      ALLOCATABLE, INTENT(IN   ) :: DbKiBuf(:)
  INTEGER(IntKi),  ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
  TYPE(BD1_inputtype), INTENT(INOUT) :: OutData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
    ! Local variables
  INTEGER(IntKi)                 :: Re_BufSz
 ...
 ! first call MeshPack to get correctly sized buffers for unpacking
  ...
  Db_Xferred   = Db_Xferred-1
  Int_Xferred  = Int_Xferred-1
 END SUBROUTINE BD1_UnPackInput

 SUBROUTINE BD1_CopyOutput( SrcOutputData, DstOutputData, CtrlCode, ErrStat, ErrMsg )
   TYPE(BD1_outputtype), INTENT(INOUT) :: SrcOutputData
   TYPE(BD1_outputtype), INTENT(INOUT) :: DstOutputData
   INTEGER(IntKi),  INTENT(IN   ) :: CtrlCode
   INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
   CHARACTER(*),    INTENT(  OUT) :: ErrMsg
! Local 
...
! 
 ...
 END SUBROUTINE BD1_CopyOutput

 SUBROUTINE BD1_DestroyOutput( OutputData, ErrStat, ErrMsg )
  TYPE(BD1_outputtype), INTENT(INOUT) :: OutputData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
  INTEGER(IntKi)                 :: i, i1, i2, i3, i4, i5 
! 
 ...
 END SUBROUTINE BD1_DestroyOutput

 SUBROUTINE BD1_PackOutput( ReKiBuf, DbKiBuf, IntKiBuf, Indata, ErrStat, ErrMsg, SizeOnly )
  REAL(ReKi),       ALLOCATABLE, INTENT(  OUT) :: ReKiBuf(:)
  REAL(DbKi),       ALLOCATABLE, INTENT(  OUT) :: DbKiBuf(:)
  INTEGER(IntKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
  TYPE(BD1_outputtype),  INTENT(INOUT) :: InData
  INTEGER(IntKi),   INTENT(  OUT) :: ErrStat
  CHARACTER(*),     INTENT(  OUT) :: ErrMsg
  LOGICAL,OPTIONAL, INTENT(IN   ) :: SizeOnly
    ! Local variables
 ...
 ! Allocate mesh buffers, if any (we'll also get sizes from these) 
  ...
  IF( ALLOCATED(Db_BldMotion_Buf) )  DEALLOCATE(Db_BldMotion_Buf)
  IF( ALLOCATED(Int_BldMotion_Buf) ) DEALLOCATE(Int_BldMotion_Buf)
 END SUBROUTINE BD1_PackOutput

 SUBROUTINE BD1_UnPackOutput( ReKiBuf, DbKiBuf, IntKiBuf, Outdata, ErrStat, ErrMsg )
  REAL(ReKi),      ALLOCATABLE, INTENT(IN   ) :: ReKiBuf(:)
  REAL(DbKi),      ALLOCATABLE, INTENT(IN   ) :: DbKiBuf(:)
  INTEGER(IntKi),  ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
  TYPE(BD1_outputtype), INTENT(INOUT) :: OutData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
    ! Local variables
  INTEGER(IntKi)                 :: Re_BufSz
 ...
 ! first call MeshPack to get correctly sized buffers for unpacking
  ...
  Db_Xferred   = Db_Xferred-1
  Int_Xferred  = Int_Xferred-1
 END SUBROUTINE BD1_UnPackOutput

 SUBROUTINE BD1_Copybladeinputdata( SrcbladeinputdataData, DstbladeinputdataData, CtrlCode, ErrStat, ErrMsg )
...
IF (ALLOCATED(SrcbladeinputdataData%station_eta)) THEN
   ...
   IF (.NOT. ALLOCATED(DstbladeinputdataData%station_eta)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_Copybladeinputdata: Error allocating DstbladeinputdataData%station_eta.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcbladeinputdataData%stiff0)) THEN
   ...
   IF (.NOT. ALLOCATED(DstbladeinputdataData%stiff0)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_Copybladeinputdata: Error allocating DstbladeinputdataData%stiff0.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcbladeinputdataData%mass0)) THEN
   ...
   IF (.NOT. ALLOCATED(DstbladeinputdataData%mass0)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_Copybladeinputdata: Error allocating DstbladeinputdataData%mass0.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcbladeinputdataData%beta)) THEN
   ...
   IF (.NOT. ALLOCATED(DstbladeinputdataData%beta)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_Copybladeinputdata: Error allocating DstbladeinputdataData%beta.'
         RETURN
      END IF
   END IF
...
ENDIF
 ...
 END SUBROUTINE BD1_Copybladeinputdata

 SUBROUTINE BD1_Destroybladeinputdata( bladeinputdataData, ErrStat, ErrMsg )
...
ENDIF
 END SUBROUTINE BD1_Destroybladeinputdata

 SUBROUTINE BD1_Packbladeinputdata( ReKiBuf, DbKiBuf, IntKiBuf, Indata, ErrStat, ErrMsg, SizeOnly )
  REAL(ReKi),       ALLOCATABLE, INTENT(  OUT) :: ReKiBuf(:)
  REAL(DbKi),       ALLOCATABLE, INTENT(  OUT) :: DbKiBuf(:)
  INTEGER(IntKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
 ...
 ! buffers to store meshes, if any
  ...
  IF ( .NOT. OnlySize ) IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = (InData%damp_flag )
  Int_Xferred   = Int_Xferred   + 1
 END SUBROUTINE BD1_Packbladeinputdata

 SUBROUTINE BD1_UnPackbladeinputdata( ReKiBuf, DbKiBuf, IntKiBuf, Outdata, ErrStat, ErrMsg )
  REAL(ReKi),      ALLOCATABLE, INTENT(IN   ) :: ReKiBuf(:)
  REAL(DbKi),      ALLOCATABLE, INTENT(IN   ) :: DbKiBuf(:)
  INTEGER(IntKi),  ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
 ...
 ! buffers to store meshes, if any
  ...
  Db_Xferred   = Db_Xferred-1
  Int_Xferred  = Int_Xferred-1
 END SUBROUTINE BD1_UnPackbladeinputdata

 SUBROUTINE BD1_Copyinputfile( SrcinputfileData, DstinputfileData, CtrlCode, ErrStat, ErrMsg )
   TYPE(bd1_inputfile), INTENT(INOUT) :: SrcinputfileData
   TYPE(bd1_inputfile), INTENT(INOUT) :: DstinputfileData
   INTEGER(IntKi),  INTENT(IN   ) :: CtrlCode
   INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
   CHARACTER(*),    INTENT(  OUT) :: ErrMsg
! Local 
...
IF (ALLOCATED(SrcinputfileData%kp_member)) THEN
   ...
   IF (.NOT. ALLOCATED(DstinputfileData%kp_member)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_Copyinputfile: Error allocating DstinputfileData%kp_member.'
         RETURN
      END IF
   END IF
...
IF (ALLOCATED(SrcinputfileData%kp_coordinate)) THEN
   ...
   IF (.NOT. ALLOCATED(DstinputfileData%kp_coordinate)) THEN 
      ...
      IF (ErrStat /= 0) THEN 
         ErrStat = ErrID_Fatal 
         ErrMsg = 'BD1_Copyinputfile: Error allocating DstinputfileData%kp_coordinate.'
         RETURN
      END IF
   END IF
...
ENDIF
   DstinputfileData%rhoinf = SrcinputfileData%rhoinf
      CALL BD1_Copybladeinputdata( SrcinputfileData%InpBl, DstinputfileData%InpBl, CtrlCode, ErrStat, ErrMsg )
   DstinputfileData%BldFile = SrcinputfileData%BldFile
   DstinputfileData%Echo = SrcinputfileData%Echo
 END SUBROUTINE BD1_Copyinputfile

 SUBROUTINE BD1_Destroyinputfile( inputfileData, ErrStat, ErrMsg )
...
ENDIF
  CALL BD1_Destroybladeinputdata( inputfileData%InpBl, ErrStat, ErrMsg )
 END SUBROUTINE BD1_Destroyinputfile

 SUBROUTINE BD1_Packinputfile( ReKiBuf, DbKiBuf, IntKiBuf, Indata, ErrStat, ErrMsg, SizeOnly )
  REAL(ReKi),       ALLOCATABLE, INTENT(  OUT) :: ReKiBuf(:)
  REAL(DbKi),       ALLOCATABLE, INTENT(  OUT) :: DbKiBuf(:)
  INTEGER(IntKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
  TYPE(bd1_inputfile),  INTENT(INOUT) :: InData
  INTEGER(IntKi),   INTENT(  OUT) :: ErrStat
  CHARACTER(*),     INTENT(  OUT) :: ErrMsg
  LOGICAL,OPTIONAL, INTENT(IN   ) :: SizeOnly
    ! Local variables
 ...
 ! buffers to store meshes, if any
  ...
  Db_BufSz   = Db_BufSz   + 1  ! rhoinf
  CALL BD1_Packbladeinputdata( Re_InpBl_Buf, Db_InpBl_Buf, Int_InpBl_Buf, InData%InpBl, ErrStat, ErrMsg, .TRUE. ) ! InpBl 
  ...
  IF ( .NOT. OnlySize ) DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) =  (InData%rhoinf )
  Db_Xferred   = Db_Xferred   + 1
  CALL BD1_Packbladeinputdata( Re_InpBl_Buf, Db_InpBl_Buf, Int_InpBl_Buf, InData%InpBl, ErrStat, ErrMsg, OnlySize ) ! InpBl 
  ...
  IF( ALLOCATED(Db_InpBl_Buf) )  DEALLOCATE(Db_InpBl_Buf)
  IF( ALLOCATED(Int_InpBl_Buf) ) DEALLOCATE(Int_InpBl_Buf)
 END SUBROUTINE BD1_Packinputfile

 SUBROUTINE BD1_UnPackinputfile( ReKiBuf, DbKiBuf, IntKiBuf, Outdata, ErrStat, ErrMsg )
  REAL(ReKi),      ALLOCATABLE, INTENT(IN   ) :: ReKiBuf(:)
  REAL(DbKi),      ALLOCATABLE, INTENT(IN   ) :: DbKiBuf(:)
  INTEGER(IntKi),  ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
  TYPE(bd1_inputfile), INTENT(INOUT) :: OutData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
    ! Local variables
  INTEGER(IntKi)                 :: Re_BufSz
 ...
 ! buffers to store meshes, if any
  ...
  OutData%rhoinf = DbKiBuf ( Db_Xferred )
  Db_Xferred   = Db_Xferred   + 1
 ! first call BD1_Packbladeinputdata to get correctly sized buffers for unpacking
  CALL BD1_Packbladeinputdata( Re_InpBl_Buf, Db_InpBl_Buf, Int_InpBl_Buf, OutData%InpBl, ErrStat, ErrMsg, .TRUE. ) ! InpBl 
  IF(ALLOCATED(Re_InpBl_Buf)) THEN
  ...
  IF(ALLOCATED(Int_InpBl_Buf)) THEN
    ...
    Int_Xferred = Int_Xferred + SIZE(Int_InpBl_Buf)
  ENDIF
  CALL BD1_UnPackbladeinputdata( Re_InpBl_Buf, Db_InpBl_Buf, Int_InpBl_Buf, OutData%InpBl, ErrStat, ErrMsg ) ! InpBl 
  Re_Xferred   = Re_Xferred-1
  Db_Xferred   = Db_Xferred-1
  Int_Xferred  = Int_Xferred-1
 END SUBROUTINE BD1_UnPackinputfile


 SUBROUTINE BD1_Input_ExtrapInterp(u, tin, u_out, tin_out, ErrStat, ErrMsg )
!
...
!..................................................................................................................................
 ...
 TYPE(BD1_inputtype), INTENT(INOUT)  :: u(:)      ! Inputs at t1 > t2 > t3
 REAL(DbKi),         INTENT(IN   )  :: tin(:)      ! Times associated with the inputs
 TYPE(BD1_inputtype), INTENT(INOUT)  :: u_out     ! Inputs at tin_out
 ...
 if ( size(t) .ne. size(u)) then
    ErrStat = ErrID_Fatal
    ErrMsg = ' Error in BD1_Input_ExtrapInterp: size(t) must equal size(u) '
    RETURN
 endif
 if (size(u) .gt. 3) then
    ErrStat = ErrID_Fatal
    ErrMsg  = ' Error in BD1_Input_ExtrapInterp: size(u) must be less than 4 '
    RETURN
 endif
 order = SIZE(u) - 1
 IF ( order .eq. 0 ) THEN
 ...
 ELSE IF ( order .eq. 1 ) THEN
  IF ( EqualRealNos( t(1), t(2) ) ) THEN
    ErrStat = ErrID_Fatal
    ErrMsg  = ' Error in BD1_Input_ExtrapInterp: t(1) must not equal t(2) to avoid a division-by-zero error.'
    RETURN
  END IF
 ...
 ELSE IF ( order .eq. 2 ) THEN
  ...
  IF ( EqualRealNos( t(2), t(3) ) ) THEN
    ErrStat = ErrID_Fatal
    ErrMsg  = ' Error in BD1_Input_ExtrapInterp: t(2) must not equal t(3) to avoid a division-by-zero error.'
    RETURN
  END IF
  IF ( EqualRealNos( t(1), t(3) ) ) THEN
    ErrStat = ErrID_Fatal
    ErrMsg  = ' Error in BD1_Input_ExtrapInterp: t(1) must not equal t(3) to avoid a division-by-zero error.'
    RETURN
  END IF
 ...
 ELSE 
   ErrStat = ErrID_Fatal
   ErrMsg = ' order must be less than 3 in BD1_Input_ExtrapInterp '
   RETURN
 ENDIF 
 END SUBROUTINE BD1_Input_ExtrapInterp


 SUBROUTINE BD1_Output_ExtrapInterp(u, tin, u_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) input u_out at time t_out, from previous/future time
! values of u (which has values associated with times in t).  Order of the interpolation is given by the size of u
!
...
!..................................................................................................................................
 ...
 TYPE(BD1_outputtype), INTENT(INOUT)  :: u(:)      ! Inputs at t1 > t2 > t3
 REAL(DbKi),         INTENT(IN   )  :: tin(:)      ! Times associated with the inputs
 TYPE(BD1_outputtype), INTENT(INOUT)  :: u_out     ! Inputs at tin_out
 REAL(DbKi),         INTENT(IN   )  :: tin_out     ! time to be extrap/interp'd to
 INTEGER(IntKi),     INTENT(  OUT)  :: ErrStat   ! Error status of the operation
 CHARACTER(*),       INTENT(  OUT)  :: ErrMsg    ! Error message if ErrStat /= ErrID_None
   ! local variables
 ...
 if ( size(t) .ne. size(u)) then
    ErrStat = ErrID_Fatal
    ErrMsg = ' Error in BD1_Output_ExtrapInterp: size(t) must equal size(u) '
    RETURN
 endif
 if (size(u) .gt. 3) then
    ErrStat = ErrID_Fatal
    ErrMsg  = ' Error in BD1_Output_ExtrapInterp: size(u) must be less than 4 '
    RETURN
 endif
 order = SIZE(u) - 1
 IF ( order .eq. 0 ) THEN
 ...
 ELSE IF ( order .eq. 1 ) THEN
  IF ( EqualRealNos( t(1), t(2) ) ) THEN
    ErrStat = ErrID_Fatal
    ErrMsg  = ' Error in BD1_Output_ExtrapInterp: t(1) must not equal t(2) to avoid a division-by-zero error.'
    RETURN
  END IF
 ...
 ELSE IF ( order .eq. 2 ) THEN
  ...
  IF ( EqualRealNos( t(2), t(3) ) ) THEN
    ErrStat = ErrID_Fatal
    ErrMsg  = ' Error in BD1_Output_ExtrapInterp: t(2) must not equal t(3) to avoid a division-by-zero error.'
    RETURN
  END IF
  IF ( EqualRealNos( t(1), t(3) ) ) THEN
    ErrStat = ErrID_Fatal
    ErrMsg  = ' Error in BD1_Output_ExtrapInterp: t(1) must not equal t(3) to avoid a division-by-zero error.'
    RETURN
  END IF
 ...
 ELSE 
   ErrStat = ErrID_Fatal
   ErrMsg = ' order must be less than 3 in BD1_Output_ExtrapInterp '
   RETURN
 ENDIF 
 END SUBROUTINE BD1_Output_ExtrapInterp

END MODULE BeamDyn1_Types
