...
\begin{align}
    ...
    \label{BDOutput}
    \mathbf{y}_{BD}^T &= \left[ \vec{f}^T~~~\vec{m}^T \right]
\end{align}
...
\begin{align}
    ...
    \label{OtherOutput}
    \mathbf{y}_{O}^T &= \left[ \vec{q}^T~~~\vec{v}^T~~~\vec{a}^T\right] 
\end{align}
